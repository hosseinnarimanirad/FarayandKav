          ...
          <MDBContainer className="text-center my-5">
            ...
            <MDBRow className="justify-content-md-center iranSansFont">              
                ...
                <MDBCol size="4">
                  ...
                  <br/>
                  <p className="rightToLeft text-justify my-2">
                  در ProcessM، ما به دنبال ساخت افزونه‌های کاربردی برای انجام تحلیل فرآیندکاوی برای ابزارهای پرکاربرد هستیم. در حال حاضر، محصول BIpm مان، افزونه تحلیلی برای فرآیندکاوی پایه در ابزار قدرتمند Power BI است که توسط شرکت مایکروسافت تایید شده و در سایت AppSource انتشار یافته است.
                  </p>
                </MDBCol>               
            </MDBRow>
          </MDBContainer>
